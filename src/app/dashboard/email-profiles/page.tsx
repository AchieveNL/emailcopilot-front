          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm" placeholder="e.g. Outreach Account" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="password" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm" placeholder="••••••••" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} />
              </div>
              <div>
