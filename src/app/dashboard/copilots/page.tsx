        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {[
            ...
            },
            {
              ...
              value: openRate(totalSent, totalOpened),
                ...
                <div className="p-5 flex items-center gap-5">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2.5 mb-1">
                      <span
                        className={`inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full ${cfg.bg} ${cfg.color}`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${cfg.dot} ${copilot.status === "active" ? "animate-pulse" : ""}`}
                        />
                        {cfg.label}
                      </span>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <span className="text-xs text-gray-300">
                        Updated{" "}
                        {new Date(copilot.updatedAt).toLocaleDateString()}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="hidden md:flex items-center gap-6 flex-shrink-0">
                    ...
                    {[
                      {
                        label: "Sent",
                        value: copilot.emailsSent.toLocaleString(),
                      },
                    ].map((s) => (
                  ...
                  <div className="px-5 pb-4">
                    <div className="h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, Math.round((copilot.emailsOpened / copilot.emailsSent) * 100))}%`,
                        }}
                      />
                    </div>
                    <p className="text-xs text-gray-400 mt-1">
                      {copilot.emailsOpened.toLocaleString()} opens out of{" "}
                      {copilot.emailsSent.toLocaleString()} sent
                    </p>
                  </div>
                )}
              </div>
