      ...
      <aside style={{
        ...
        <div style={{ padding: '1.5rem 1.25rem 1.25rem', borderBottom: '1px solid rgba(0,0,0,0.07)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: '0.875rem', fontWeight: 600, color: '#111118', letterSpacing: '-0.01em' }}>EmailCopilot</div>
        ...
        <div style={{ padding: '1rem 1.25rem', borderTop: '1px solid rgba(0,0,0,0.07)' }}>
          <div style={{ fontSize: '0.7rem', color: '#a0a0b0' }}>v2.0.0 · outreach system</div>
        </div>
      </aside>
