...
{{sender_name}}`,
  ...
  return (
    <div className="bg-white border absolute z-100 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 border-gray-200 rounded-2xl shadow-sm w-90 overflow-hidden">
      {/* Header */}
