...
function Cta() {
    return (
        <section className="relative mx-auto mb-20 w-275 overflow-hidden rounded-3xl px-6 py-20 text-center">
...
*/}
            ...
            <div className="relative z-10">
                <h2 className="mb-4 font-serif text-[clamp(1.8rem,4vw,3rem)] font-normal tracking-[-0.02em] text-[#fafafa]">
