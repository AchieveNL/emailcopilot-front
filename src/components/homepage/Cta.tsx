  ...
  return (
    <section className="relative mx-auto mb-20 max-w-315 w-full overflow-hidden rounded-3xl px-6 py-20 text-center">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(87.84deg, #4F46E5 0%, #2563EB 57.04%, #06B6D4 98.86%)",
        }}
      />

      {/* add a dotted bg to the card */}
      <div className="absolute inset-0 bg-[radial-gradient(rgba(255,255,255,0.15)_1px,transparent_1px)] bg-[size:16px_16px]" />
