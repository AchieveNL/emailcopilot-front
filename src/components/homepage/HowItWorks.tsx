...
function StepBadge({ number, color }: { number: number; color: string }) {
  return (
    <div className="flex items-center gap-2">
      <div
        className={`w-6 h-6 rounded-full border border-${color} flex items-center justify-center text-xs font-semibold text-${color} flex-shrink-0`}
      >
        {number}
      </div>
    </div>
    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col gap-8 min-h-[220px]">
      ...
      <div className="flex-1">
        <div className="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden text-[11.5px]">
          ...
          {/* Subject */}
          <div className="flex items-center gap-2 px-3 py-2 border-b border-gray-100">
            <span className="text-gray-400 text-[11px] min-w-[36px]">
              Subject
            </span>
          ...
          {/* Send button */}
          <div
            className="mx-3 mb-3 rounded-lg px-3 py-2.5 flex items-center justify-between text-white text-[12px] font-semibold"
            style={{
              background:
...
export default function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative py-16 px-4 max-w-315 w-full overflow-hidden"
    >
