...
export const STEPS = [
  {
    ...
    desc: "Tell EmailCopilot what kind of businesses to find. A search query is all it takes.",
  },
  {
    num: "02",
    title: "We find & contact them",
    desc: "The system scrapes leads and sends personalised cold emails automatically — every day.",
  },
  {
    num: "03",
    title: "You close the meetings",
    desc: "Replies land in your inbox. Your team qualifies and books. You focus on what matters.",
  },
];
...
export const TESTIMONIALS = [
  {
    quote:
      "EmailCopilot has completely transformed our outbound process. We book more meetings with less manual work.",
    name: "Karim Saber",
  ...
  {
    quote:
      "We went from zero outbound to 15 qualified meetings a month in just 6 weeks. The ROI is insane for the price.",
    name: "Laura Meijer",
  ...
  {
    quote:
      "Finally a tool that doesn't require a sales ops team to run. I set it up in an afternoon and it just works.",
    name: "Tomas Varga",
    role: "CEO, ScaleStack",
    avatar: "TV",
    color: "#22c55e",
  ...
  {
    quote:
      "The personalisation is surprisingly good. Our open rates jumped from 18% to 41% in the first month.",
    name: "Nina Hofmann",
